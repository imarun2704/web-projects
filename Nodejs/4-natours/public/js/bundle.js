...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiYXJ1bmhhcGxhYno3NyIsImEiOiJjazR6NnB2bjYwMmJlM2VxbmxjZjZoM2p3In0.2M7fZahwVx04qYqh9n5KQw';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/arunhaplabz77/ck4z7b0sv1ozb1cmjmx3c65fv',
...
var stripe = Stripe('pk_test_Xwr0kw6lCU7kgx9XdUPHoz9y00WmCr64PX');
...
if (userDataForm) userDataForm.addEventListener('submit', function (e) {
  e.preventDefault();
  console.log('fgfgfhgfgfhg', userDataForm);
...
if (bookBtn) bookBtn.addEventListener('click', function (e) {
  ...
  console.log(tourId, 'linking checking    cdafcadsfdfdssssssssss');
