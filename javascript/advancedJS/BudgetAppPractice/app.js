...
var UIController = (function () {
  ...
  var formatNumber =  function(num, type) {
    var numSplit;
     ...
     numSplit = num.split('.');
      ...
      int = numSplit[0];
      if(int.length > 3) {
        int = int.substr(0,int.length - 3) + ',' + int.substr(int.length - 3,3); // input 2310 ,op 2,310
      }
  ...
  return {
    getInput: function () {
      ...
      return {     // will be either inc or exp
...
var controller = (function (budgetCtrl, UICtrl) {
  ...
  return {    //these code in the object will be placed outside
    init: function () {
